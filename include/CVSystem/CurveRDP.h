...
namespace CVSystem
{
	...
	public:
		...
		// RDP flags
		static void RDPst(std::vector<std::vector<MyPoint>> polys, std::vector<bool>& pointFlags, std::vector<MyPoint> &points, double epsilon, int startIndex, int endIndex, double rdp_point_min);
		// RDP flags
		static void RDPst2(std::vector<bool>& pointFlags, std::vector<MyPoint> &points, double epsilon, int startIndex, int endIndex, double rdp_point_min);
